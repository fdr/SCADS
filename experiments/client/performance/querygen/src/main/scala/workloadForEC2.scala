...
object WorkloadRunnerForEC2 {
	...
	//def populateDB(paramMap:Map[String, List[String]], emailDupFactor:Int, thoughtsPerUser:Int, subsPerUser:Int, hashTagsPerThought:Int)(implicit env:Environment) = {
	def populateDB(paramMap:Map[String, List[String]], emailDupFactor:Int, thoughtsPerUser:Int, subsPerUser:Int)(implicit env:Environment) = {
		...
		*/
		...
		//if (sz == 0) {
			...
			val thoughtGenerator = new SimpleThoughtGenerator(thoughtsPerUser, env)
	...
	//def getParamMap(numUsers:Int, emailDupFactor:Int, numThoughts:Int, numDistinctHashTags:Int): Map[String, List[String]] = {
	def getParamMap(numUsers:Int, emailDupFactor:Int, numThoughts:Int, numDistinctHashTags:Int): Map[String, List[String]] = {
		val queryLogger = Logger.getLogger("queryLogger")
		// Usernames
