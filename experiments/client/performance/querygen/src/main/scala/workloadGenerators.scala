...
object WorkloadGenerators {
	...
	*/
	val mixUserByName = new MixVector(Map("userByName"->1.0,"userByEmail"->0.0,"thoughtstream"->0.0,"myFollowing"->0.0))
	val mixUserByEmail = new MixVector(Map("userByName"->0.0,"userByEmail"->1.0,"thoughtstream"->0.0,"myFollowing"->0.0))
	val mixThoughtstream = new MixVector(Map("userByName"->0.0,"userByEmail"->0.0,"thoughtstream"->1.0,"myFollowing"->0.0))
	val mixMyFollowing = new MixVector(Map("userByName"->0.0,"userByEmail"->0.0,"thoughtstream"->0.0,"myFollowing"->1.0))
