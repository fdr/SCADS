...
object DeployQuerygen extends ConfigurationActions {
	def main(args:Array[String]) {
		...
		val storageService = deployStorageEngine(scalaengineJarDir, storageNode, zooNode, false, storageEnginePort, zookeeperPort)
		...
		*/
		...
		val clientService = createJavaServiceWithCustomLog4jConfigFile(clientNode, 
			new File(querygenJarDir + "/querygen-2.0-SNAPSHOT-jar-with-dependencies.jar"),
